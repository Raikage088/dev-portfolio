...
## 🛠️ Tech Stack & Skills
> 💡 *Tip: Generate beautiful badges at [Shields.io](https://shields.io/) or [SimpleIcons](https://simpleicons.org/)*

**Languages:** `[JavaScript]` `[Python]` `[Kotlin]` `[SQL]`  
**Frontend:** `[React]` `[Tailwind CSS]` `[HTML/CSS]`  
**Backend:** `[Node.js]` `[Express]` `[FastAPI]` `[Django]`  
**Databases & Cloud:** `[MySQL]` `[MongoDB]` `[Firebase]`  
**Tools & Workflow:** `[Git]` `[Docker]` `[CI/CD]` `[Figma]`  


## 📫 Get In Touch
I'm always open to connecting, discussing new opportunities, or collaborating on interesting projects!

- 📧 **Email:** [your.email@example.com](mailto:xyrsjhn@gmail.com)
- 💼 **LinkedIn:** [linkedin.com/in/yourprofile](https://www.linkedin.com/in/xyrus-john-p-vertucio-141358392/)
- 🐙 **GitHub:** [github.com/yourusername]([https://github.com/yourusername](https://github.com/Raikage088))
- 🌐 **Live Portfolio:** [yourportfolio.com](https://placeholder.com)
